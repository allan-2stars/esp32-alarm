...
//void startMelodyLoop(const int* melody, int length, int tempo, int buzzerPin);

void startMelody(
    const int* melody, int length, int tempo, int pin, bool loop = false
);//bool is true, then repeat melody
